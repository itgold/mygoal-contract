...
import "../MyGoalToken.sol";

/**
 * @title RefundVault
 * @dev This contract is used for storing TOKENS AND ETHER while a crowdsale is in progress for a period of 30 DAYS.
...
contract RefundVault is Claimable {
    ...
    // Refund time frame
    //todo: good timeframe for refunds?
    uint256 public constant REFUND_TIME_FRAME = 30 days;

    mapping(address => uint256) public depositedETH;
    mapping(address => uint256) public depositedToken;

    address public etherWallet;
    MyGoalToken public token;
    State public state;
    ...
    constructor(address _etherWallet, MyGoalToken _token) public {
    ...
    function refundETH(uint256 ETHToRefundAmountWei) isInRefundTimeFrame isRefundingState public {
        ...
        //todo: replace destroy with transefer
